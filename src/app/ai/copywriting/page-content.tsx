...
const generateNoAiContent = () => `今天想跟你们聊一个最近特别有感触的事。

周末逛街路过一家小店，店主是个刚毕业的姑娘。她说开店是她从大学就有的梦想，毕业攒了一年工资，终于把店开起来了。店面不大，但每一处布置都能看出用心。

我站在店里突然想到——有多少人心里装着想做但还没开始的事情？总觉得要准备得完美了再出发。可哪有什么"万事俱备"，最难的其实就是迈出第一步。

或许你的梦想不需要很大，不需要很完美，不需要所有人都理解。只要你自己相信，就值得去试一把。哪怕只是一个小店、一个账号、一门手艺，开始了，就已经赢了大多数人。
