...
import { FileText, Image as ImageIcon, Video as VideoIcon, Music, Mic, ChevronRight, Play, FileAudio, Grid3x3, BarChart3, Send, TrendingUp, Scissors } from "lucide-react";
  ...
  return (
    <div className="flex flex-col min-h-screen pb-20">
      ...
      <div className="flex-1 px-4 pt-4 space-y-5">
        ...
        {/* ─── AI 工具 ─── */}
        <div>
          <p style={{ ...sectionLabel, marginBottom: 8 }}>AI 工具</p>
