...
const features: FeatureEntry[] = [
  {
    ...
    highlights: [
      ...
      'Step 1 过滤(默认排除 AI 作品 + 空内容,避免二次创作放大 AI 味),可手动展开显示 AI 作品并标 ⚠️ AI 警告',
...
const faqs: FAQEntry[] = [
  ...
  {
    q: 'AI 文案 Step 1 为什么看不到我之前存的灵感?',
    a: 'V2.0.2 起 Step 1 默认会过滤掉两类内容:1) AI 作品 (source_platform="ai")——避免二次创作放大 AI 味;2) 空内容(无原文无 ai_summary)。\n\n如果确实想看 AI 作品二次创作,点列表上方的"⚠️ 显示 AI 作品" chip 展开即可。每条 AI 作品右侧会标黄底"AI"标签。\n\n为什么这么设计: AI 创作平台如果反复拿 AI 文案当素材,会出现"AI 味自我强化"的怪圈,人类风格被稀释。所以默认排除,但保留显式开启的通道。',
  },
  {
