...
const features: FeatureEntry[] = [
  ...
  },
  {
    icon: <Mic size={20} />,
    title: 'AI 数字人',
    desc: '照片 + 音频 → 口型同步视频（20 秒短视频），6 种模式覆盖不同场景。',
    color: '#06B6D4',
    highlights: [
      '6 种工作模式：一键生数字人、AI写稿、批量生成、多语言、用我的形象（角色动作迁移）、手动配置（tab 顺序从左到右）',
