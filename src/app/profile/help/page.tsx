...
const features: FeatureEntry[] = [
  ...
  },
  {
    icon: <Globe size={20} />,
    title: '换人复刻（A方案）',
    desc: '提取原视频口播文案 → 换上新主角照片 → Agnes AI 从零生成新人物口播视频。原生口型同步+配音，画面由AI重新生成。',
    color: '#EC4899',
    highlights: [
      'A方案-文案复刻：保留文案和节奏，画面全由 AI 重新生成',
      '使用方式：提供原视频链接 + 新主角照片，说"帮我把这个视频换成这个人"',
      '自动流程：提取原视频口播文案 → 照片+文案 → Agnes Video V2.0 生成',
      '原生口型同步 + 中文配音，无需后配 TTS',
      '时长控制：帧数 81-441（≈3-18 秒），默认 161 帧（≈6.7 秒）',
      '适用场景：创始人 IP 矩阵、虚拟主播、纯口播换人翻拍',
      '如需保留原场景/产品，请用下方「视频换脸（B方案）」',
    ],
    path: '/capture',
  },
  {
    icon: <Globe size={20} />,
    title: '视频换脸（B方案）',
    desc: '保留原视频场景/运镜/产品/灯光/背景，仅替换出镜人物。阿里云 wan2.2-animate-mix 像素级换脸，不重生成画面。',
    color: '#F43F5E',
    highlights: [
      ...
      '原视频要求：2-30 秒，≤200MB，人物正面出镜效果最佳',
      '适用场景：带货视频换主播、口播矩阵换人、品牌本地化',
      '生成时间约 2-5 分钟，视频自动保存到灵感库',
    ],
    path: '/capture',
  },
  {
...
const faqs: FAQEntry[] = [
  ...
  {
    q: '换人复刻和视频换脸有什么区别？',
    a: '灵集提供两种换人方案，适用不同场景：\n\n**A方案-换人复刻**（Agnes Video V2.0）：提取原视频口播文案 → 照片+文案 → AI 从零生成新视频。只保留文案，画面全由AI重新生成，场景/运镜/产品会变。适合纯口播、虚拟主播。\n\n**B方案-视频换脸**（wan2.2-animate-mix）：原视频 + 新人物照片 → 像素级换脸。原视频的场景/产品/运镜/灯光/背景完全保留，只换出镜人物。适合带货视频换主播、产品展示视频。\n\n怎么选：如果你需要保留手里的产品、背景布置、灯光效果 → 选B方案。如果你只在意口播文案，画面无所谓 → 选A方案。\n\n两种方案都可以直接在 AI 助手对话中使用，Agent 会根据你的描述自动判断该用哪种。',
  },
  {
    q: '换人复刻是什么？怎么使用？',
    a: '换人复刻是把口播视频的主角替换为新人物，保留原口播文案和节奏，生成新人物口播视频。\n\n使用方式：在 AI 助手对话中发送原视频链接 + 新主角照片，说"帮我把这个视频换成这个人"。\n\n流程：(1) AI 用 extract_content 提取原视频口播文案（语音转文字）；(2) 用照片+文案调用 Agnes Video V2.0 生成新视频；(3) 新视频自动保存到灵感库。\n\n也可以跳过提取，直接给照片 + 已写好的口播文案，Agent 会直接生成视频。\n\n技术要求：新主角照片需正面、清晰、五官可见。视频时长由帧数控制：默认 161 帧（≈6.7 秒，约 40 字），最长 441 帧（≈18.4 秒）。\n\n适用场景：创始人 IP 矩阵（同一文案多人出镜）、虚拟主播批量内容、口播视频换人翻拍。\n\n💡 提示：如需保留原视频的场景和产品，请用「视频换脸」（B方案）。',
  },
  {
    q: '如何使用多平台内容提取功能？',
...
const guides: GuideSection[] = [
  ...
  },
  {
    ...
    color: '#EC4899',
    steps: [
      { step: 1, content: '在 AI 助手中提供原视频链接（或直接给口播文案）+ 新主角照片 URL' },
      { step: 2, content: '已有原视频 → AI 先调 extract_content 提取口播文案（语音转文字）' },
      { step: 3, content: 'AI 根据文案字数自动选择合适的帧数（40字→161帧/6.7秒，60字→241帧/10秒）' },
      { step: 4, content: '调用 generate_agnes_video，照片+文案 → Agnes Video V2.0 生成新视频' },
      { step: 5, content: '原生口型同步 + 中文配音自动生成，无需后配 TTS' },
      { step: 6, content: '视频生成后自动保存到灵感库，可预览、下载、复用' },
      { step: 7, content: '需要更短/更长视频？告诉 AI 调整 numFrames 参数即可' },
    ],
  },
  {
    title: '视频换脸（B方案-像素级）',
    ...
    steps: [
      ...
      { step: 3, content: 'AI 判断为 B方案 → 直接调用 video_face_swap 工具' },
      { step: 4, content: '原视频+照片 → wan2.2-animate-mix 像素级换脸（保留场景/产品/运镜）' },
      { step: 5, content: '等待 2-5 分钟，视频生成后自动保存到灵感库' },
      { step: 6, content: '如需更高质量，可要求用 wan-pro 专业模式重新生成' },
    ],
  },
  {
    title: '完善账号设置',
