...
const features: FeatureEntry[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      '当前 V2.0.3 试运行:加油包为模拟支付(¥1 也到账),真实微信/支付宝待 V2.0.4 接入',
    ],
...
const guides: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { step: 4, content: '点「立即购买」→ 弹确认窗(明确标注「V2.0.3 试运行,模拟支付,¥1 也到账」)→ 点「确认支付」' },
      { step: 5, content: '支付成功立即到账,1-2 秒后自动跳回「我的灵感点」看到新余额;流水里会记「购买加油包 xxx」+ 赠送明细' },
      { step: 6, content: '订阅升级: 个人中心 → 我的灵感点 → 订阅套餐 → 5 档可选(免费/个人/创作者/Studio/企业)→ 点「立即订阅」→ 弹确认窗(V2.0.3 试运行,模拟支付)→ 立即到账首月 credits + 30 天有效期,到期前一天自动续费 + 赠送下月 credits' },
      { step: 7, content: '取消订阅:订阅套餐页 → 选「降级到免费版」立即取消自动续费(当前周期 credits 仍可用到期);也可在「我的灵感点 → 订阅历史」里点「取消自动续费」' },
    ],
  },
];
