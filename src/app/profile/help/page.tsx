...
const features: FeatureEntry[] = [
  ...
  },
  {
    icon: <Globe size={20} />,
    title: '换人复刻',
    desc: '提取原视频口播文案 → 换上新主角照片 → AI 生成新人物口播视频。Agnes Video V2.0 原生口型同步+配音，无需后配。',
    color: '#EC4899',
    highlights: [
      '使用方式：在 AI 助手对话中提供原视频链接 + 新主角照片，说"帮我把这个视频换成这个人"',
      '自动流程：提取原视频口播文案 → 照片+文案 → Agnes 生成新视频',
      '也可跳过提取，直接给照片 + 口播文案（自己写或从其他地方复制）',
      '原生口型同步 + 中文配音，无需后配 TTS',
      '时长控制：帧数 81-441（≈3-18 秒），默认 161 帧（≈6.7 秒，约 40 字）',
      '适用场景：创始人 IP 矩阵、虚拟主播、口播视频换人翻拍',
      '视频自动保存到灵感库，带「AI 生成」标签',
    ],
    path: '/capture',
  },
  {
