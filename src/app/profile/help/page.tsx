...
const features: FeatureEntry[] = [
  ...
  },
  {
    icon: <Globe size={20} />,
    title: '口播视频生成（A方案）',
    desc: '一张人物照片 + 一段口播文案 → AI 生成口播短视频。原生口型同步+配音+运镜（缓推+微动），电影感光影和浅景深。照片场景即视频背景。',
    color: '#EC4899',
    highlights: [
...
const guides: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { step: 4, content: 'AI 根据文案字数自动选帧数（40字→161帧/6.7秒，60字→241帧/10秒）' },
      { step: 5, content: '调用 generate_agnes_video → Agnes Video V2.0 生成带运镜的口播视频' },
      { step: 6, content: '运镜效果：镜头缓推+手持微动+背景虚化，电影感光影' },
      { step: 7, content: '视频自动保存到灵感库，可预览、下载、批量生成矩阵内容' },
    ],
  },
  {
    title: '视频换脸（B方案-像素级）',
